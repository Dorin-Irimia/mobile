    ...
    <View style={styles.root}>
      ...
      >
        ...
        >
          ...
          {/* Sincronizare cu cheltuielile casnice — feature highlight, mutat sus
              ca să fie ușor de văzut. Stiluri distincte (border accentuat,
              fundal tint) ca să nu se piardă printre celelalte carduri. */}
          {households.length > 0 && (
            <TouchableOpacity
              activeOpacity={0.85}
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.syncSub}>
                    {syncToHousehold
                      ...
                      : 'O singură atingere și suma intră automat și în portofelul casei.'}
                  </Text>
                </View>
                <Switch
...
const styles = StyleSheet.create({
  ...
  // Sync-to-household feature highlight card.
  syncCard: {
